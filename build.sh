...
# Generate defconfig
if [ ! $skip ]; then
	scripts/kconfig/merge_config.sh -m arch/arm64/configs/vendor/bengal-perf_defconfig arch/arm64/configs/vendor/debugfs.config arch/arm64/configs/vendor/ext_config/moto-bengal.config arch/arm64/configs/vendor/ext_config/cebu-default.config || exitGracefully
fi
